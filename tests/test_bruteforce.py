...
def test_bruteforce_wipe(tmp_path):
    ...
    for attempt in range(1, 6):
        ...
        if attempt < 5:
            ...
            remaining = 5 - attempt
            assert f"Contraseña maestra incorrecta. Te quedan {remaining} intentos." in result.output
            ...
            assert "Demasiados intentos fallidos; el vault ha sido eliminado por seguridad." in result.output
